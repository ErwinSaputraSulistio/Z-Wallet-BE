...
exports.resetPassword = (jwtToken, userEmail) => {
   const sendThisMail = {
     from: 'ciwin.tickitz@gmail.com',
     to: userEmail,
     subject: 'Z-Wallet: Reset Password',
     html:
       `<!DOCTYPE html>
       <html lang="en">
          <head>
          ...
          <body>
             <div class="container">
                ...
                <div style="margin: auto; margin-top: 40px; width: 100%;">
                   <a class="verifyLink" href="https://z-wallet-erwinsaputrasulistio.vercel.app/create-new-password/${jwtToken}"><div class="verifyBtn">Reset Password</div></a>
                </div>
             </div>
          </body>
       </html>`
